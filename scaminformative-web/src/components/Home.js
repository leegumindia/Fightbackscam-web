          ...
          <div className="row">
            <div className="col-10 mx-auto">
              <div className="row" >
                ...
                <div data-aos="slide-up" className="col-md-7 pt-5  d-flex justify-content-center flex-column home">
                  ...
                  Have you been a victim of <span style={{fontWeight:'bold'}}>online fraud?</span> Whether it's a <span style={{fontWeight:'bold'}}>phishing scam, identity theft</span> experiencing online fraud can be stressful and overwhelming. You're not alone.  <br></br>
                  </h2>
