...
import image4 from "../images/complain.png";
import image5 from "../images/unity1.png";
import image6 from "../images/justice1.png";

function HowHelp() {
   return (
    <>
     <div>
         <h1 className="page-text" style={{color:'#484646'}}>How do we help you?</h1> 
        </div>
        ...
        <div className="container-fluid nav_bg"style={{overflowX:'hidden'}}>
          <div className="row">
            <div className="col-10 mx-auto">
              <div className="row" >
              <div className="col-6 mt-3 header-img"data-aos="zoom-in">
                  <img
                    src={image1}
                ...
                <div className="col-6  d-flex justify-content-center flex-column home-text">
                <h2  style={{color:'#EF7820'}}>
                    <strong>
                    Register your Scam      
                    </strong>
                  </h2>
      ...
      <section  id="header" className="d-flex align-items-center ">
        ...
        <div className="container-fluid nav_bg"style={{overflowX:'hidden'}}>
          <div className="row">
            <div className="col-10 mx-auto">
              <div className="row" >
              <div className="col-7  d-flex justify-content-center flex-column home-text">
              ...
              <div className="col-5 mt-3 header-img"data-aos="zoom-in">
                  <img
                    src={image2}
                    className="img-fluid sm:w-screen lg:w-screen mt-5"
                    alt="home-img"
        ...
        <div className="col-10 mx-auto">
          ...
          <div className="col-6 mt-3 header-img"data-aos="zoom-in">
            ...
            <h1  style={{color:'#EF7820'}}>
              ...
              <p className="my-3 content" style={{color:'black'}}>
              <span style={{fontWeight:'bold'}}>We won't stop until justice is served</span>. <br>
              </br>Once we have enough evidence, we'll bring your case directly to the police or relevant authorities. 
              We'll advocate for you every step of the way, ensuring your complaint is registered and swift action is taken
              </p>
        ...
        <div className="col-10 mx-auto">
          ...
          <div className="col-7  d-flex justify-content-center flex-column home-text">
            <h1  style={{color:'#2D5767'}}>
              ...
              <p className="my-3 content" style={{color:'#2D5767'}}>
              Our team is actively <span style={{fontWeight:'bold'}}>collecting evidence from across India</span> to build strong cases<br></br>
              against scammers. By submitting your proofs, you contribute to our collective <br></br>
              effort to combat fraud
              </p>
