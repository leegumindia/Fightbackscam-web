...
function HowHelp() {
  return (
    <>
      <div>
        {/* <h1 className="page-text">We're here to help!</h1> */}
              ...
              <div className="row">
                <div className="col-md-7  pt-lg-0 orer-2 order-lg-1 d-flex justify-content-center flex-column home-text1">
                  <h2 className="sub-text" style={{ color: "#EF7820" }}>
                    <strong>Report Fraud Case</strong>
                  </h2>

                  <p className="my-3 content" style={{ color: "black" }}>
                    Have you or someone you care about been{" "}
                    <span style={{ fontWeight: "bold" }}>scammed online?</span>
                    <br></br>
                    Tell us your story and help others avoid the same{" "}
                    <span style={{ fontWeight: "bold" }}>fraud</span>.<br></br>
                    We're here to listen and learn, so the more details you
                    share, the better we can fight! <br></br>
                  </p>
                ...
                <div
                  className="col-lg-5 col-sm-app col-md-5 order-1 order-lg-2 header-img1"
                  data-aos="zoom-in"
                >
                  <img
                    src={image1}
              ...
              <div className="row">
                <div className="col-md-7 pt-5 pt-lg-0 orer-2 order-lg-1 d-flex justify-content-center flex-column home-text">
                  <h1 style={{ color: "#EF7820" }}>
                    <strong>Collecting proofs nation wide</strong>
                  </h1>
                  ...
                  <p className="my-3 content" style={{ color: "black" }}>
                    ...
                    against scammers. By submitting your proofs, you contribute
                    to our collective <br></br>
          ...
          <div className="row">
            <div className="col-10 mx-auto">
              <div className="row">
                <div className="col-md-7 pt-5 pt-lg-0 orer-2 order-lg-1 d-flex justify-content-center flex-column home-text">
                  <h1 style={{ color: "#EF7820" }}>
                    <strong>Fight against scams</strong>
                  </h1>
