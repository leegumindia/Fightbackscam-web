...
export default function App() {
  return (
    <MDBFooter style={{backgroundColor:'#033443'}} className='text-center text-lg-start text-muted'>
      <section className='d-flex justify-content-center justify-content-lg-between p-4 border-bottom'>
        ...
        <div>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill='#FFFFFF' width={"20"} height={"20"}>
          ...
          <a href='' className='me-4 text-reset'>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" fill='#FFFFFF' width={"20"} height={"20"}>
        ...
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            <MDBCol md='3' lg='4' xl='3' className='mx-auto mb-4'>
              ...
              <p>
                If you have been a victim of online scam don't hesitate to report on our website
              </p>
            </MDBCol>
      ...
      <div className='text-center p-4' style={{ backgroundColor: 'rgba(0, 0, 0, 0.05)', color:'white' }}>
        © 2024 Copyright:
        <a className='text-reset fw-bold' href='https://fightbackscams.com/' style={{color:'white',textDecoration:'none'}}>
          fightbackscams.com
        </a>
      </div>
    </MDBFooter>
